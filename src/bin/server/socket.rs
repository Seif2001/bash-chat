...
impl Socket{
    pub async fn new(address_election_tx:String, address_election_rx: String, address_failover_tx: String, address_failover_rx:String, address_client: String, address_client_tx: String) -> Self{
        ...
        let socket_client_tx = Arc::new(Mutex::new(UdpSocket::bind(address_client_tx).await.expect("Error binding")));
