...
pub struct Socket{
    ...
    pub socket_client_image_request_rx: Arc<Mutex<UdpSocket>>
}

impl Socket{
    pub async fn new(address_server_1:String, address_server_2: String, address_server_3: String, client_address_leader_rx: String, client_address_tx: String, client_address_rx: String, address_client_dos_tx:String,address_client_dos_rx:String, client_image_request_rx: String) -> Self{
        ...
        let socket_client_image_request_rx = Arc::new(Mutex::new(UdpSocket::bind(client_image_request_rx).await.expect("Error binding")));
        ...
        Socket{
            ...
            socket_client_image_request_rx
        }
    }
